...
htmlhelp_basename = 'Flask-AppFactorydoc'
...
latex_documents = [
  ('index', 'Flask-AppFactory.tex', u'Flask-AppFactory Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    ('index', 'flask-appfactory', u'Flask-AppFactory Documentation',
     [u'CERN'], 1)
]
...
texinfo_documents = [
  ('index', 'Flask-AppFactory', u'Flask-AppFactory Documentation',
   u'CERN', 'Flask-AppFactory', 'One line description of project.',
   'Miscellaneous'),
]
